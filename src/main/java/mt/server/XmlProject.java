...
public class XmlProject {
   public void transactionsXml (Order o){
      try {	
         ...
         System.out.println();System.out.println("Customer of Order" + o.getServerOrderID() + str);
         
         // Create new element Order with attributes
         Element newElement = doc.createElement("Order");
         newElement.setAttribute("Id", o.getNickname());
         if(o.isBuyOrder()){
         ...
         newElement.setAttribute("Units", String.valueOf(o.getNumberOfUnits()));
         newElement.setAttribute("Price", String.valueOf(o.getPricePerUnit()));
